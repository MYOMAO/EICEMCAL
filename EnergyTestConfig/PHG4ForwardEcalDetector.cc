...
//  G4double thickness_scintillator = thickness_layer * (4.0/5.6);  // 4mm scintillator
  ...
  G4double thickness_absorber = WRadLength/scalar ;      // W 1.5mm absorber  W: 1X0 = 3.5 mm
  G4double thickness_scintillator = WRadLength/(scalar * AbSciRatio);  // W 4mm scintillator
