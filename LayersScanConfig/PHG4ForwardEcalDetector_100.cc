...
PHG4ForwardEcalDetector::ConstructTowerType2()
{
  ...
  string name_scintillator = m_TowerLogicNamePrefix + "_single_plate_scintillator2";
	...
	/*	
  ofstream FEMCALInfo("FEMCALInfo.txt",ios::app);

  FEMCALInfo <<  "name_absorber  = " << name_absorber <<  "     thickness_absorber = " << thickness_absorber <<  endl;
  FEMCALInfo <<  "name_scintillator  = " << name_scintillator <<  "     thickness_scintillator = " << thickness_scintillator << endl;
	*/
