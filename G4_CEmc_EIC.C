...
double scint_width = 1.5e-1;
double tungs_width = scalefactor * 1.03e-1 * 80 / 19.35 / (80 / 19.35 + 20 / 8.96) ;
double copper_width = scalefactor * 1.03e-1 * 20 / 8.96 / (80 / 19.35 + 20 / 8.96) ;
