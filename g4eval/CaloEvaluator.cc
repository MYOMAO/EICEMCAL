  ...
  if (Verbosity() > 1)
  {
         ...
         ++iter)
    {
           ...
           ++clusiter)
      {
        ...
        ERECOGlobal = cluster->get_energy();
	
	//	cout << "ERECOGlobal1 = " << ERECOGlobal << endl;
...
//	  NClustersGlobal = clusters->size();
      ...
      if (cluster)
      {
        ...
        ERECOGlobal = cluster->get_energy();
	//	cout << "FUckin Out Side X = " << x << endl; 
    //	cout << "FUckin Out Side E = " << e << endl; 
  ...
  if (_do_cluster_eval)
  {
	...
	//  cout << "_reco_e_threshold = " << _reco_e_threshold << endl;
...
//   cout << "FUckin Out Side X = " << x << endl; 
//	  cout << "ERECOGlobal3 = " << ERECOGlobal << endl;
